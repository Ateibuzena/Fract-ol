...
extern const LodePNGCompressSettings lodepng_default_complexpress_settings;
...
unsigned compress(std::vector<unsigned char>& out, const unsigned char* in, size_t insize,
                  const LodePNGCompressSettings& settings = lodepng_default_complexpress_settings);
...
*) text_complexpression: default 1. If 1, it'll store texts as zTXt instead of tEXt chunks.
...
state.encoder.text_complexpression: use compressed text chunks for metadata
