 ...
 * 
 * @param[in] mlx The MLX instance handle.
 * @param[in] imaginary The image to draw on the screen.
 ...
 * 
 * @param[in] imaginary The image to resize.
